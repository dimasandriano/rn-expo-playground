...
const inputStyle = tva({
  base: 'border-gray-300 bg-neutral-200 flex-row overflow-hidden content-center data-[disabled=true]:opacity-40 data-[disabled=true]:hover:border-background-300 items-center rounded-xl',
